...
class FilesConcatenation
{
    ...
    static void Main()
    {
        ...
        StreamReader firstFile = GetFileReader(GetFullPath("first", "read"));
        StreamReader secondFile = GetFileReader(GetFullPath("second", "read"));
        StreamWriter streamWriter = GetStreamWriter(GetFullPath("new", "write to"));
        WriteToFile(firstFile, streamWriter);
        WriteToFile(secondFile, streamWriter);
        firstFile.Close();
        secondFile.Close();
        streamWriter.Close();
