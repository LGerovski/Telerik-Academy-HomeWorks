...
class ReplaceWords
{
    ...
    static void Main()
    {
        Console.WriteLine("This program replaces all occurrences of the word\n" +
            "\"start\" with the word \"finish\" in a text file.");
        ...
        Regex pattern = new Regex(@"\bstart\b");
        string output = pattern.Replace(input, "finish");
        fileContent.Clear();
