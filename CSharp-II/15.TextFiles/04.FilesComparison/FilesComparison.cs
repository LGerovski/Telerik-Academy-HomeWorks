...
class FilesComparison
{
    ...
    static void CompareFiles(StreamReader firstFile, StreamReader secondFile)
    {
        int equal = 0;
        int different = 0;
        ...
        Console.WriteLine("the number of equal lines in the files is: {0}", equal);
        Console.WriteLine("the number of different lines in the files is: {0}", different);
    }
    static void Main()
    {
        Console.WriteLine("This program compares two text files line by line and prints\n" + 
            "the number of lines that are the same and the number of lines\n" +
            "that are different.");
        StreamReader firstFile = GetFileReader(GetFullPath("first", "compare"));
        StreamReader secondFile = GetFileReader(GetFullPath("second", "compare"));
